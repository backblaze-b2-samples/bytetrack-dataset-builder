...
from app.runtime import datasets, files, health, metrics, upload  # noqa: E402
...
app = FastAPI(
    title="ByteTrack Dataset Builder API",
    description=(
        "Turn raw video on Backblaze B2 into training-ready multi-object "
        "tracking datasets with a keyless object detector + ByteTrack"
    ),
    version="0.1.0",
    lifespan=lifespan,
)
