"""B2 data-access helpers for the tracking-dataset builder.
...
- put_bytes(key, data, ctype)  -> write per-track clips / labels.zip
- put_json(key, obj)           -> write annotations / manifests / dataset.json
...
Every delete is scoped to a dataset/<id>/ prefix — never bucket-wide — so a
...
def delete_prefix(prefix: str) -> int:
    ...
    SAFETY: callers must pass a dataset-scoped prefix (dataset/<id>/). This
