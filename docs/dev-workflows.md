...
- E2E: `pnpm test:e2e` (run `pnpm --filter @bytetrack-dataset-builder/web exec playwright install chromium` once first)
- Build a dataset (needs the ML stack): `pnpm build:dataset`
